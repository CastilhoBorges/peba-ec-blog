...
const POSTS = [
  {
    type: "anuncio",
    slug: "racha-17-reais-e-mensalista",
    date: "2026-09-20",
    dateLabel: "20 Set 2026",
    title: "Racha a R$ 17,00 e as 10 vagas de mensalista",
    icon: "🎟️",
    body: [
      "Fala, rapaziada! ⚽ Dois avisos sobre os sabadões.",
      "<strong>1) O racha passa a ser R$ 17,00</strong>",
      "A gente tá penando pra achar goleiro toda semana. Resolvemos contratar um fixo, que vem todo sábado e já sabe como a gente joga — e pra bancar isso o valor do racha sobe pra <strong>R$ 17,00</strong>.",
      "Ficamos à disposição pra manter os R$ 15,00 caso 2 goleiros do nosso grupo se disponibilizem a ajudar a gente no sabadão.",
      "<strong>2) Agora vamos ter MENSALISTA 🎟️</strong>",
      "Vamos abrir 10 vagas de mensalista. O pacote é assim:",
      "• 4 jogos por mês",
      "• 10% de desconto → sai <strong>R$ 61,20</strong> em vez de R$ 68,00",
      "• Dá <strong>R$ 15,30 por jogo</strong> em vez de R$ 17,00",
      "• Economia de <strong>R$ 8,30 por mês</strong>",
      "E não é só o desconto. Quem é mensalista tem:",
      "✅ Entra na lista <strong>24h antes</strong> de todo mundo",
      "✅ Vaga confirmada na hora, sem prazo de pagamento correndo",
      "✅ Desistiu com mais de <strong>48h</strong> de antecedência? O crédito volta pro seu saldo",
      "✅ Usa os créditos em qualquer racha do grupo, você escolhe quais",
      "<strong>Por que a gente tá fazendo isso?</strong>",
      "Dois motivos. O primeiro é caixa: com uma parte do mês já garantida, a gente consegue fechar quadra e goleiro com antecedência, sem depender de quantos confirmam na semana. O segundo é ajudar e favorecer quem tá sempre aqui — se você não perde um sábado, é justo pagar menos e ter prioridade na lista.",
      "São só 10 vagas e é uma por pessoa.",
      "<strong>Como virar mensalista, passo a passo</strong>",
      "1. Abra o Elenko e entre no grupo do Peba Esporte Club (o botão aí embaixo leva direto).",
      "2. Na tela do grupo, toque no card <strong>“Vire mensalista”</strong> e depois em <strong>“Ver mensalidade”</strong>.",
      "3. Escolha o pacote de 4 jogos. A própria tela mostra quantas das 10 mensalidades ainda restam.",
      "4. Escolha como pagar: <strong>Pix</strong> (vale 1 mês, depois você recompra) ou <strong>cartão</strong> (renova sozinho todo mês e custa um pouquinho mais, por causa da taxa da bandeira).",
      "5. Toque em <strong>“Assinar”</strong> e pague. Os créditos entram assim que o pagamento cai.",
      "Depois é só entrar nos rachas normalmente. Quando a lista abrir, você vê o aviso de que mensalista entra primeiro: o crédito paga o jogo e a vaga confirma na hora, sem prazo correndo atrás de você.",
      "Sobre os valores que aparecem no app: as taxinhas do Pix e do Elenko entram por cima, do mesmo jeito que já rola no racha avulso (tá tudo explicado no post do pagamento pelo app). A diferença é que o mensalista paga uma taxa de Pix só, em vez de uma por sábado — e é daí que sai boa parte da economia de R$ 8,30.",
      "E se cancelar, tranquilo: você fica com os créditos já pagos até o fim do ciclo.",
      "Qualquer dúvida, chama no grupo. Nos vemos no sábado. ⚽"
    ],
    cta: {
      label: "Virar mensalista no Elenko",
      href: "https://jogar.elenko.app/convite/ea77b186-9224-4766-a48f-3f3b4c36d85f",
      nota: "São 10 vagas, uma por pessoa — quem entrar primeiro garante."
    }
  },
  {
    type: "anuncio",
